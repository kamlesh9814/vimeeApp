...
import com.vimee.apps.databinding.ActivityTimeOnlineBinding

class TimeOnlineActivity : AppCompatActivity() {
    lateinit var binding: ActivityTimeOnlineBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTimeOnlineBinding.inflate(layoutInflater)
        onClick()
        colorChange()
    ...
    private fun onClick() {
        binding.ContinueLayout1.setOnClickListener {
            startActivity(Intent(this@TimeOnlineActivity, NativeLanguageActivity::class.java))
        }
